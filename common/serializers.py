class AuditSerializerMixin:
    """Sella el actor desde el request, para serializers usados fuera de una vista con AuditViewMixin (ambos componen de forma segura: imponen el mismo actor del request).
